...
public class SorcererListController
{
    ...
    public void InitializeCharacterList(VisualElement root, VisualTreeAsset listElementTemplate)
    {
        ...
        m_CharacterList = root.Q<ListView>("SorcererList");
    ...
    List<SorcererDataSO> m_AllCharacters;

    void EnumerateAllCharacters()
    {
        m_AllCharacters = new List<SorcererDataSO>();
        m_AllCharacters.AddRange(Resources.LoadAll<SorcererDataSO>("Sorcerers"));
    }
    ...
    void FillCharacterList()
    {
        ...
        m_CharacterList.makeItem = () =>
        {
            ...
            var newListEntryLogic = new SorcererListEntry();
        ...
        {
            (item.userData as SorcererListEntry).SetCharacterData(m_AllCharacters[index]);
        };
    ...
    void OnCharacterSelected(IEnumerable<object> selectedItems)
    {
        ...
        var selectedCharacter = m_CharacterList.selectedItem as SorcererDataSO;
